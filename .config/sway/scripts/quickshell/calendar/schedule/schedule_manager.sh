...
# UPDATED: Script Paths now point to your new Sway calendar setup
UPDATER_SCRIPT="$HOME/.config/sway/scripts/quickshell/calendar/schedule/get_schedule.py"
SHELL_NIX="$HOME/.config/sway/scripts/quickshell/calendar/schedule/shell.nix"
