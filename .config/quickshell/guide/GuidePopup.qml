...
PopupShell {
    ...
    function buildKeybinds() {
        ...
        let binds = [
            ...
            { k1: "SUPER", k2: "B", action: "Toggle Battery", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleBattery" },
            { k1: "SUPER", k2: "N", action: "Toggle Network", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleNetwork" },
            { k1: "SUPER", k2: "M", action: "Toggle Monitors", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleMonitors" },
            { k1: "SUPER", k2: "H", action: "Toggle Guide", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleGuide" },
            { k1: "SUPER+SHIFT", k2: "S", action: "Toggle Settings", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleSettings" },
            { k1: "SUPER+SHIFT", k2: "T", action: "Toggle FocusTime", cmd: "qs -p ~/.config/quickshell/Main.qml ipc call main toggleFocusTime" },
