...
PopupShell {
    ...
    readonly property var baseApps: [
        ...
        { name: "Lock Screen", desc: "Lock current user session", icon: "\u{f023}", cmd: "bash " + Quickshell.env("HOME") + "/.config/sway/scripts/session/lock.sh", cat: "Session" },
        ...
        { name: "Screenshot (Area)", desc: "Capture selected region", icon: "\u{f030}", cmd: "bash " + Quickshell.env("HOME") + "/.config/sway/scripts/tools/screenshot.sh", cat: "Utilities" },
        { name: "Screenshot (Full)", desc: "Capture entire screen", icon: "\u{f108}", cmd: "bash " + Quickshell.env("HOME") + "/.config/sway/scripts/tools/screenshot.sh --full", cat: "Utilities" },
